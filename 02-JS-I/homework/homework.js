...
function obtenerAreaRectangulo(alto, ancho) {
  ...
  // Tu código:
 var áreaDeRectángulo = (alto*ancho) 
 return áreaDeRectángulo;
}
...
function retornarPerimetro(lado){
  ...
  var perímetroDelCuadrado = (lado+lado+lado+lado)
  return perímetroDelCuadrado;
}
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
  var áreaTriángulo = ((base*altura)/2)
